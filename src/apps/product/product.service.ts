...
import { findProducts, findProductById, insertProduct, deleteProduct, editProduct } from './product.repository'
...
export { getAllProducts, getProductById, createProduct, deleteProductById, editProductById }
